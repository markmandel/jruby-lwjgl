...
#
#  overlapping items, with a depth buffer.
#  file:///home/mark/Desktop/Tutorial%200.3.8/html/Positioning/Tut05%20Overlap%20and%20Depth%20Buffering.html
class OpenGL::DepthBuffer
	...
	def initialize
		...
		create_display("Overlap with Depth Buffer");
	...
	def display
		...
		GL30.gl_bind_vertex_array(@vao_id)
		GL20.gl_uniform3f(@offset_location, 0.0, 0.0, -1.0) #nice overlap
		#GL20.gl_uniform3f(@offset_location, 0.0, 0.0, 0.0) #no overlap
		...
		GL32.gl_draw_elements_base_vertex(GL11::GL_TRIANGLES, @index_data.size, GL11::GL_UNSIGNED_SHORT, 0, 36.0 / 2)
